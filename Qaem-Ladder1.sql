...
-- select *, round(salary/1.1,  2) as salary_in_euros
-- from employees
...
-- select firstname ||', '|| lastname as fullname , round(salary/1.1,  2) as salary_eu
-- from employees
...
-- select firstname ||', '|| lastname as fullname, STRFtime('%Y', startdate) as startyear, '$'|| format('%,d',salary) as salary
-- from employees
